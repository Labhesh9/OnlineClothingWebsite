...
const ItemDetails = () => {
 ...
 // const items = useSelector((state) => state.cart.items);
  ...
  const [item, setItem] = useState({ id:0, productId: 0, name: "", description: "", nameDetail: "", imageproduct: "", originalPrice: "", agetypesId: "", category: ""});
  ...
  async function getItem() {
    ...
    const item = await fetch(
      `http://localhost:4000/api/productDetail/${itemId}`,
      {
        method: "GET",
      }
    );
      ...
      <Box display="flex" flexWrap="wrap" columnGap="40px">
        ...
        <Box flex="1 1 50%" mb="40px">
          ...
          <Box m="65px 0 25px 0">
            ...
            <Typography>${item?.originalPrice}</Typography>
