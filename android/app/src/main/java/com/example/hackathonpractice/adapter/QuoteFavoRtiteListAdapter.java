...
public class QuoteFavoRtiteListAdapter extends RecyclerView.Adapter<QuoteFavoRtiteListAdapter.MyViewHolder> {
    Context context;
    List<Quote> quoteList;
    private static  int tmp=0;
    public QuoteFavoRtiteListAdapter(Context context, List<Quote> quoteList) {
    ...
    @NonNull
    @Override
    public QuoteFavoRtiteListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
